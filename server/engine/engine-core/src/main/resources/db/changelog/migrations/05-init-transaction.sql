...
--changeset SergeyLabuzov:add-transactions-index-idx_transactions_wallets__fk
...
--changeset SergeyLabuzov:add-transactions-index-idx_transactions_categories__fk
