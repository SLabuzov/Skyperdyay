...
import { currentMonthPeriod } from "@/lib/utils";


export default async function TransactionsPage() {

  const { startPeriod, endPeriod } = currentMonthPeriod();
  ...
  return (
    <div className="flex flex-col flex-1 gap-4 px-8">
      <div className="flex items-center justify-between h-10">
        <h1 className="text-base font-bold text-gray-600">Детальная информация по платежам за текущий месяц</h1>
