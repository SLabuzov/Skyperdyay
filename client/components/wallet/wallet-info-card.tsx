...
export default function WalletInfoCard({ walletInfo }: Props) {
  ...
  return (
    <Link href={ `/wallets/${ walletInfo.walletId }` }
          className="flex items-center border-1 border-[#e5e6e6] rounded-xl p-4 gap-4 hover:bg-[#ecf4e9]">
      ...
      <div className="flex flex-col justify-between m-1">
        <p className="text-sm font-medium text-[#6B7271]">{ walletInfo.walletName }</p>
